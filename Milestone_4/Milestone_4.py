...
rho, x, y  = Stability_Region(Explicit_Euler, 1000, -4, 4, -4, 4)
plt.subplot(2, 2, 1)
...
plt.subplot(2, 2, 3)
rho, x, y  = Stability_Region(RungeKutta_4, 100, -4, 4, -4, 4)
plt.grid( axis = 'both' , color = 'gainsboro' , linestyle = 'dashed' )
plt.axhline(0, color='black', linewidth=0.5)
plt.axvline(0, color='black', linewidth=0.5)
plt.contour( x, y, transpose(rho), linspace(0, 1, 11) )
...
plt.subplot(2, 2, 4)
rho, x, y  = Stability_Region(Crank_Nicolson, 100, -4, 2, -4, 4)
plt.grid( axis = 'both' , color = 'gainsboro' , linestyle = 'dashed' )
plt.axhline(0, color='black', linewidth=0.5)
plt.axvline(0, color='black', linewidth=0.5)
plt.contour( x, y, transpose(rho), linspace(0, 1, 11) )
...
#schemes = [Explicit_Euler, Inverse_Euler, Crank_Nicolson, RungeKutta_4] 
#for scheme in schemes: 
#    
#    rho, x, y  = Stability_Region(scheme, 1000, -5, 5, -5, 5)
#    plt.contour( x, y, transpose(rho), linspace(0, 1, 11) )
#    plt.axis('equal')
#    plt.grid()
#    plt.show()