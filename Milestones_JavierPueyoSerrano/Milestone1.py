...
print( "" )
input()
print( "   Seleccione el esquema numerico que desea utilizar para la resolucion:")
print( "" )
print( "     1. Metodo de Euler (multipaso explicito)")
print( "     2. Metodo de Crank-Nicolson (multipaso implicito)")
print( "     3. Metodo Runge-Kutta de 4 etapas (unipaso)")
print( "" )
eleccion = int(input("   Introduzca la opcion elegida: "))
print( "" )
...
if eleccion == 1:
	...
	print("   Ha seleccionado el Metodo de Euler (explicito).")
	input()
	...
	plt.title(r'\textbf{Orbita} (Metodo de Euler)', loc = "center", fontdict = {'fontsize':14, 'color':'k'})
	...
	print("   Ha seleccionado el Metodo Crank-Nicolson.")
	input()
	...
	plt.xlim( [ -1.15 , 1.15 ] )
	plt.plot( x , y , color = 'b')
	plt.title(r'\textbf{Orbita} (Metodo Crank-Nicolson)', loc = "center", fontdict = {'fontsize':14, 'color':'k'})
	plt.ylabel("$y$", fontdict = {'fontsize':12, 'fontweight':'normal', 'color':'k'})
	plt.xlabel("$x$", fontdict = {'fontsize':12, 'fontweight':'normal', 'color':'k'})
	plt.show()
	...
	print("   Ha seleccionado el Metodo Runge-Kutta de 4 etapas.")
	input()
	...
	plt.xlim( [ -1.15 , 1.15 ] )
	plt.plot( x , y , color = 'b')
	plt.title(r'\textbf{Orbita} (Metodo Runge-Kutta 4)', loc = "center", fontdict = {'fontsize':14, 'color':'k'})
	plt.ylabel("$y$", fontdict = {'fontsize':12, 'fontweight':'normal', 'color':'k'})
	plt.xlabel("$x$", fontdict = {'fontsize':12, 'fontweight':'normal', 'color':'k'})
	plt.show()
