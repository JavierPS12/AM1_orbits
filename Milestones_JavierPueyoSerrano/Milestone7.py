...
from Maths_Equations.VanDerPol import VanDerPol_Libre, VanDerPol_ForzadoArmonico, VanDerPol_ForzadoEstocastico, VanDerPol_Libre2, VanDerPol_Libre3
...
U_0 = array([0,0])
U1 =  Cauchy_Problem( VanDerPol_ForzadoArmonico, t, U_0, AB4 )
U_01 = array([0.1,0.1])
U2 =  Cauchy_Problem( VanDerPol_ForzadoArmonico, t, U_01, AB4 )
#U3 =  Cauchy_Problem( VanDerPol_Libre3, t, U_0, AB4 )
#print(U1)
##Plot_2D(U1[:,0],U1[:,1],'x','y')
##plt.show()
...
#plt.show()
create_animation(U1,10,25,'VDPL_arm_0.gif',N)
